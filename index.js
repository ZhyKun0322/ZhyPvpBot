...
bot.once('spawn', () => {
  ...
  armor = armorManager(bot); // Correct use
...
function equipArmorAndWeapons() {
  ...
  if (armor && armor.equipAll) armor.equipAll().catch(console.error);
}
...
// 💤 Updated sleep logic with `physicsTick`
bot.on('physicsTick', () => {
